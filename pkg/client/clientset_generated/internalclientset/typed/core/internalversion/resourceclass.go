...
type ResourceClassInterface interface {
	Create(*api.ResourceClass) (*api.ResourceClass, error)
	Update(*api.ResourceClass) (*api.ResourceClass, error)
	UpdateStatus(*api.ResourceClass) (*api.ResourceClass, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*api.ResourceClass, error)
	List(opts v1.ListOptions) (*api.ResourceClassList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *api.ResourceClass, err error)
...
func newResourceClasses(c *CoreClient) *resourceClasses {
...
func (c *resourceClasses) Create(resourceClass *api.ResourceClass) (result *api.ResourceClass, err error) {
	result = &api.ResourceClass{}
	err = c.client.Post().
...
func (c *resourceClasses) Update(resourceClass *api.ResourceClass) (result *api.ResourceClass, err error) {
	result = &api.ResourceClass{}
	err = c.client.Put().
		Resource("resourceclasses").
...
func (c *resourceClasses) UpdateStatus(resourceClass *api.ResourceClass) (result *api.ResourceClass, err error) {
	result = &api.ResourceClass{}
	err = c.client.Put().
		Resource("resourceclasses").
		Name(resourceClass.Name).
...
func (c *resourceClasses) Get(name string, options v1.GetOptions) (result *api.ResourceClass, err error) {
	result = &api.ResourceClass{}
	err = c.client.Get().
		Resource("resourceclasses").
		Name(name).
...
func (c *resourceClasses) List(opts v1.ListOptions) (result *api.ResourceClassList, err error) {
	result = &api.ResourceClassList{}
	err = c.client.Get().
		Resource("resourceclasses").
...
func (c *resourceClasses) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *api.ResourceClass, err error) {
	result = &api.ResourceClass{}
