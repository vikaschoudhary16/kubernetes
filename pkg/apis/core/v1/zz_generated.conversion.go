...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_ComputeResource_To_core_ComputeResource,
		Convert_core_ComputeResource_To_v1_ComputeResource,
		...
		Convert_v1_DeviceList_To_core_DeviceList,
		Convert_core_DeviceList_To_v1_DeviceList,
...
func autoConvert_v1_ComputeResource_To_core_ComputeResource(in *v1.ComputeResource, out *core.ComputeResource, s conversion.Scope) error {
...
func autoConvert_core_ComputeResource_To_v1_ComputeResource(in *core.ComputeResource, out *v1.ComputeResource, s conversion.Scope) error {
	// WARNING: in.ResourceName requires manual conversion: does not exist in peer-type
	out.Properties = *(*map[string]string)(unsafe.Pointer(&in.Properties))
	out.Devices = *(*[]string)(unsafe.Pointer(&in.Devices))
	out.Units = in.Units
	return nil
...
func autoConvert_v1_Container_To_core_Container(in *v1.Container, out *core.Container, s conversion.Scope) error {
	...
	out.TTY = in.TTY
	out.AllocatedComputeResources = *(*map[string]core.DeviceList)(unsafe.Pointer(&in.AllocatedComputeResources))
	return nil
}
...
func autoConvert_core_Container_To_v1_Container(in *core.Container, out *v1.Container, s conversion.Scope) error {
	...
	out.StdinOnce = in.StdinOnce
	out.TTY = in.TTY
	out.AllocatedComputeResources = *(*map[string]v1.DeviceList)(unsafe.Pointer(&in.AllocatedComputeResources))
	return nil
}
...
func autoConvert_v1_DeviceList_To_core_DeviceList(in *v1.DeviceList, out *core.DeviceList, s conversion.Scope) error {
	out.Count = in.Count
	out.UIDs = *(*[]types.UID)(unsafe.Pointer(&in.UIDs))
	return nil
}

// Convert_v1_DeviceList_To_core_DeviceList is an autogenerated conversion function.
func Convert_v1_DeviceList_To_core_DeviceList(in *v1.DeviceList, out *core.DeviceList, s conversion.Scope) error {
	return autoConvert_v1_DeviceList_To_core_DeviceList(in, out, s)
}

func autoConvert_core_DeviceList_To_v1_DeviceList(in *core.DeviceList, out *v1.DeviceList, s conversion.Scope) error {
	out.Count = in.Count
	out.UIDs = *(*[]types.UID)(unsafe.Pointer(&in.UIDs))
	return nil
}

// Convert_core_DeviceList_To_v1_DeviceList is an autogenerated conversion function.
func Convert_core_DeviceList_To_v1_DeviceList(in *core.DeviceList, out *v1.DeviceList, s conversion.Scope) error {
	return autoConvert_core_DeviceList_To_v1_DeviceList(in, out, s)
}
