...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_AllRequiredSelectors, InType: reflect.TypeOf(&AllRequiredSelectors{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_MatchExpSelector, InType: reflect.TypeOf(&MatchExpSelector{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_ResourceClass, InType: reflect.TypeOf(&ResourceClass{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_ResourceClassList, InType: reflect.TypeOf(&ResourceClassList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_ResourceClassSpec, InType: reflect.TypeOf(&ResourceClassSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_api_ResourceClassStatus, InType: reflect.TypeOf(&ResourceClassStatus{})},
...
// DeepCopy_api_AllRequiredSelectors is an autogenerated deepcopy function.
func DeepCopy_api_AllRequiredSelectors(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*AllRequiredSelectors)
		out := out.(*AllRequiredSelectors)
		*out = *in
		if in.MatchExpSelectors != nil {
			in, out := &in.MatchExpSelectors, &out.MatchExpSelectors
			*out = make([]MatchExpSelector, len(*in))
			for i := range *in {
				if err := DeepCopy_api_MatchExpSelector(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_MatchExpSelector is an autogenerated deepcopy function.
func DeepCopy_api_MatchExpSelector(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*MatchExpSelector)
		out := out.(*MatchExpSelector)
		*out = *in
		if in.Values != nil {
...
// DeepCopy_api_ResourceClass is an autogenerated deepcopy function.
func DeepCopy_api_ResourceClass(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClass)
		out := out.(*ResourceClass)
		*out = *in
		if newVal, err := c.DeepCopy(&in.ObjectMeta); err != nil {
			return err
		} else {
		...
		if err := DeepCopy_api_ResourceClassSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_api_ResourceClassStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_api_ResourceClassList is an autogenerated deepcopy function.
func DeepCopy_api_ResourceClassList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClassList)
		out := out.(*ResourceClassList)
		*out = *in
		if in.Items != nil {
			in, out := &in.Items, &out.Items
			*out = make([]ResourceClass, len(*in))
			for i := range *in {
				if err := DeepCopy_api_ResourceClass(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_api_ResourceClassSpec is an autogenerated deepcopy function.
func DeepCopy_api_ResourceClassSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClassSpec)
		out := out.(*ResourceClassSpec)
		*out = *in
		if err := DeepCopy_api_AllRequiredSelectors(&in.Required, &out.Required, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_api_ResourceClassStatus is an autogenerated deepcopy function.
func DeepCopy_api_ResourceClassStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClassStatus)
		out := out.(*ResourceClassStatus)
		*out = *in
