...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors,
		Convert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors,
		...
		Convert_v1_MatchExpSelector_To_api_MatchExpSelector,
		Convert_api_MatchExpSelector_To_v1_MatchExpSelector,
		...
		Convert_v1_ResourceClass_To_api_ResourceClass,
		Convert_api_ResourceClass_To_v1_ResourceClass,
		Convert_v1_ResourceClassList_To_api_ResourceClassList,
		Convert_api_ResourceClassList_To_v1_ResourceClassList,
		Convert_v1_ResourceClassSpec_To_api_ResourceClassSpec,
		Convert_api_ResourceClassSpec_To_v1_ResourceClassSpec,
		Convert_v1_ResourceClassStatus_To_api_ResourceClassStatus,
		Convert_api_ResourceClassStatus_To_v1_ResourceClassStatus,
...
func autoConvert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors(in *AllRequiredSelectors, out *api.AllRequiredSelectors, s conversion.Scope) error {
	out.MatchExpSelectors = *(*[]api.MatchExpSelector)(unsafe.Pointer(&in.MatchExpSelectors))
	return nil
}

// Convert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors is an autogenerated conversion function.
func Convert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors(in *AllRequiredSelectors, out *api.AllRequiredSelectors, s conversion.Scope) error {
	return autoConvert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors(in, out, s)
}

func autoConvert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors(in *api.AllRequiredSelectors, out *AllRequiredSelectors, s conversion.Scope) error {
	out.MatchExpSelectors = *(*[]MatchExpSelector)(unsafe.Pointer(&in.MatchExpSelectors))
	return nil
}

// Convert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors is an autogenerated conversion function.
func Convert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors(in *api.AllRequiredSelectors, out *AllRequiredSelectors, s conversion.Scope) error {
	return autoConvert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors(in, out, s)
}
...
func autoConvert_v1_MatchExpSelector_To_api_MatchExpSelector(in *MatchExpSelector, out *api.MatchExpSelector, s conversion.Scope) error {
	out.Key = in.Key
	out.Operator = string(in.Operator)
	out.Values = *(*[]string)(unsafe.Pointer(&in.Values))
	return nil
}

// Convert_v1_MatchExpSelector_To_api_MatchExpSelector is an autogenerated conversion function.
func Convert_v1_MatchExpSelector_To_api_MatchExpSelector(in *MatchExpSelector, out *api.MatchExpSelector, s conversion.Scope) error {
	return autoConvert_v1_MatchExpSelector_To_api_MatchExpSelector(in, out, s)
}

func autoConvert_api_MatchExpSelector_To_v1_MatchExpSelector(in *api.MatchExpSelector, out *MatchExpSelector, s conversion.Scope) error {
	out.Key = in.Key
	out.Operator = OperatorType(in.Operator)
	out.Values = *(*[]string)(unsafe.Pointer(&in.Values))
	return nil
}

// Convert_api_MatchExpSelector_To_v1_MatchExpSelector is an autogenerated conversion function.
func Convert_api_MatchExpSelector_To_v1_MatchExpSelector(in *api.MatchExpSelector, out *MatchExpSelector, s conversion.Scope) error {
	return autoConvert_api_MatchExpSelector_To_v1_MatchExpSelector(in, out, s)
}
...
func autoConvert_v1_ResourceClass_To_api_ResourceClass(in *ResourceClass, out *api.ResourceClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_v1_ResourceClassSpec_To_api_ResourceClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_v1_ResourceClassStatus_To_api_ResourceClassStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_ResourceClass_To_api_ResourceClass is an autogenerated conversion function.
func Convert_v1_ResourceClass_To_api_ResourceClass(in *ResourceClass, out *api.ResourceClass, s conversion.Scope) error {
	return autoConvert_v1_ResourceClass_To_api_ResourceClass(in, out, s)
}

func autoConvert_api_ResourceClass_To_v1_ResourceClass(in *api.ResourceClass, out *ResourceClass, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	if err := Convert_api_ResourceClassSpec_To_v1_ResourceClassSpec(&in.Spec, &out.Spec, s); err != nil {
		return err
	}
	if err := Convert_api_ResourceClassStatus_To_v1_ResourceClassStatus(&in.Status, &out.Status, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_ResourceClass_To_v1_ResourceClass is an autogenerated conversion function.
func Convert_api_ResourceClass_To_v1_ResourceClass(in *api.ResourceClass, out *ResourceClass, s conversion.Scope) error {
	return autoConvert_api_ResourceClass_To_v1_ResourceClass(in, out, s)
}

func autoConvert_v1_ResourceClassList_To_api_ResourceClassList(in *ResourceClassList, out *api.ResourceClassList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]api.ResourceClass)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1_ResourceClassList_To_api_ResourceClassList is an autogenerated conversion function.
func Convert_v1_ResourceClassList_To_api_ResourceClassList(in *ResourceClassList, out *api.ResourceClassList, s conversion.Scope) error {
	return autoConvert_v1_ResourceClassList_To_api_ResourceClassList(in, out, s)
}

func autoConvert_api_ResourceClassList_To_v1_ResourceClassList(in *api.ResourceClassList, out *ResourceClassList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	if in.Items == nil {
		out.Items = make([]ResourceClass, 0)
	} else {
...
// Convert_api_ResourceClassList_To_v1_ResourceClassList is an autogenerated conversion function.
func Convert_api_ResourceClassList_To_v1_ResourceClassList(in *api.ResourceClassList, out *ResourceClassList, s conversion.Scope) error {
	return autoConvert_api_ResourceClassList_To_v1_ResourceClassList(in, out, s)
}

func autoConvert_v1_ResourceClassSpec_To_api_ResourceClassSpec(in *ResourceClassSpec, out *api.ResourceClassSpec, s conversion.Scope) error {
	if err := Convert_v1_AllRequiredSelectors_To_api_AllRequiredSelectors(&in.Required, &out.Required, s); err != nil {
		return err
	}
	return nil
}

// Convert_v1_ResourceClassSpec_To_api_ResourceClassSpec is an autogenerated conversion function.
func Convert_v1_ResourceClassSpec_To_api_ResourceClassSpec(in *ResourceClassSpec, out *api.ResourceClassSpec, s conversion.Scope) error {
	return autoConvert_v1_ResourceClassSpec_To_api_ResourceClassSpec(in, out, s)
}

func autoConvert_api_ResourceClassSpec_To_v1_ResourceClassSpec(in *api.ResourceClassSpec, out *ResourceClassSpec, s conversion.Scope) error {
	if err := Convert_api_AllRequiredSelectors_To_v1_AllRequiredSelectors(&in.Required, &out.Required, s); err != nil {
		return err
	}
	return nil
}

// Convert_api_ResourceClassSpec_To_v1_ResourceClassSpec is an autogenerated conversion function.
func Convert_api_ResourceClassSpec_To_v1_ResourceClassSpec(in *api.ResourceClassSpec, out *ResourceClassSpec, s conversion.Scope) error {
	return autoConvert_api_ResourceClassSpec_To_v1_ResourceClassSpec(in, out, s)
}

func autoConvert_v1_ResourceClassStatus_To_api_ResourceClassStatus(in *ResourceClassStatus, out *api.ResourceClassStatus, s conversion.Scope) error {
	out.Capacity = in.Capacity
	out.Allocatable = in.Allocatable
	return nil
}

// Convert_v1_ResourceClassStatus_To_api_ResourceClassStatus is an autogenerated conversion function.
func Convert_v1_ResourceClassStatus_To_api_ResourceClassStatus(in *ResourceClassStatus, out *api.ResourceClassStatus, s conversion.Scope) error {
	return autoConvert_v1_ResourceClassStatus_To_api_ResourceClassStatus(in, out, s)
}

func autoConvert_api_ResourceClassStatus_To_v1_ResourceClassStatus(in *api.ResourceClassStatus, out *ResourceClassStatus, s conversion.Scope) error {
	out.Capacity = in.Capacity
	out.Allocatable = in.Allocatable
	return nil
}

// Convert_api_ResourceClassStatus_To_v1_ResourceClassStatus is an autogenerated conversion function.
func Convert_api_ResourceClassStatus_To_v1_ResourceClassStatus(in *api.ResourceClassStatus, out *ResourceClassStatus, s conversion.Scope) error {
	return autoConvert_api_ResourceClassStatus_To_v1_ResourceClassStatus(in, out, s)
}
