...
func RegisterDeepCopies(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedDeepCopyFuncs(
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_AllRequiredSelectors, InType: reflect.TypeOf(&AllRequiredSelectors{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_MatchExpSelector, InType: reflect.TypeOf(&MatchExpSelector{})},
		...
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ResourceClass, InType: reflect.TypeOf(&ResourceClass{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ResourceClassList, InType: reflect.TypeOf(&ResourceClassList{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ResourceClassSpec, InType: reflect.TypeOf(&ResourceClassSpec{})},
		conversion.GeneratedDeepCopyFunc{Fn: DeepCopy_v1_ResourceClassStatus, InType: reflect.TypeOf(&ResourceClassStatus{})},
...
// DeepCopy_v1_AllRequiredSelectors is an autogenerated deepcopy function.
func DeepCopy_v1_AllRequiredSelectors(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.MatchExpSelectors != nil {
			...
			*out = make([]MatchExpSelector, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_MatchExpSelector(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_v1_MatchExpSelector is an autogenerated deepcopy function.
func DeepCopy_v1_MatchExpSelector(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
...
// DeepCopy_v1_ResourceClass is an autogenerated deepcopy function.
func DeepCopy_v1_ResourceClass(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClass)
		...
		*out = *in
		...
		if err := DeepCopy_v1_ResourceClassSpec(&in.Spec, &out.Spec, c); err != nil {
			return err
		}
		if err := DeepCopy_v1_ResourceClassStatus(&in.Status, &out.Status, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_v1_ResourceClassList is an autogenerated deepcopy function.
func DeepCopy_v1_ResourceClassList(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		...
		*out = *in
		if in.Items != nil {
			...
			*out = make([]ResourceClass, len(*in))
			for i := range *in {
				if err := DeepCopy_v1_ResourceClass(&(*in)[i], &(*out)[i], c); err != nil {
					return err
				}
			}
		}
...
// DeepCopy_v1_ResourceClassSpec is an autogenerated deepcopy function.
func DeepCopy_v1_ResourceClassSpec(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
		in := in.(*ResourceClassSpec)
		out := out.(*ResourceClassSpec)
		*out = *in
		if err := DeepCopy_v1_AllRequiredSelectors(&in.Required, &out.Required, c); err != nil {
			return err
		}
		return nil
	}
...
// DeepCopy_v1_ResourceClassStatus is an autogenerated deepcopy function.
func DeepCopy_v1_ResourceClassStatus(in interface{}, out interface{}, c *conversion.Cloner) error {
	{
