...
func postProcessOpenAPISpecForBackwardCompatibility(s *spec.Swagger) (*spec.Swagger, error) {
	compatibilityMap := map[string]string{
		...
		"io.k8s.kubernetes.pkg.apis.computeresources.v1alpha1.ResourceClass":                           "io.k8s.api.computeresources.v1alpha1.ResourceClass",
		"io.k8s.kubernetes.pkg.apis.computeresources.v1alpha1.ResourceClassList":                       "io.k8s.api.computeresources.v1alpha1.ResourceClassList",
		"io.k8s.kubernetes.pkg.apis.computeresources.v1alpha1.ResourceClassSpec":                       "io.k8s.api.computeresources.v1alpha1.ResourceClassSpec",
		"io.k8s.kubernetes.pkg.apis.computeresources.v1alpha1.ResourceClassStatus":                     "io.k8s.api.computeresources.v1alpha1.ResourceClassStatus",
