...
func (s *KubeletServer) AddFlags(fs *pflag.FlagSet) {
	...
	fs.BoolVar(&s.CgroupsNumaSupport, "cgroups-numa-support", s.CgroupsNumaSupport, "Enable creation of cpuset cgroup hierarchy, if true top level cgroup nodes, corresponding to each NUMA node detected, are created")
