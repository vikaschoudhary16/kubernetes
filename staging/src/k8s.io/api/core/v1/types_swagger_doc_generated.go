...
var map_PodSpec = map[string]string{
	...
	"hostUserNamespace":             "Use the host's user namespace. Optional: Defaults to empty This field is alpha-level and should be enabled on a node only if user-namespace remapping feature is enabled at runtime.",
